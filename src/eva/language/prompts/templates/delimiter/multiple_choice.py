"""Prompt templates for multiple choice questions with delimiter-based output format."""
...
class DelimiterMultipleChoicePromptTemplate(base.PromptTemplate):
    """Prompt template for multiple choice questions with answers after #### delimiter."""
    ...
    template: str = textwrap.dedent(
        ...
        IMPORTANT: Think step-by-step before giving your final answer, then output the final answer after "#### ".
    ...
    def render(
        ...
        *,
        ...
        Args:
            ...
            example_answer: Optional example answer for the delimiter snippet. Defaults to first option.
            ...
            enable_cot: This parameter is ignored for delimiter templates as CoT is always enabled.
