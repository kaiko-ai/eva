...
class TIGERBase(
    ...
    def annotations(self) -> Dict[str, Any]:
        """Task-specific annotations (classification labels, regression targets, etc.)."""
    ...
    def _load_file_paths(self, split: Literal["train", "val", "test"] | None = None) -> List[str]:
        ...
        Splits are assigned 70% train, 15% val, 15% test but can be dynamically defined if required.
        """
