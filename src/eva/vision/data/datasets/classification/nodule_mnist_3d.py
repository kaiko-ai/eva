...
class NoduleMNIST3D(medmnist.NoduleMNIST3D):
    """Chest CT Binary-Class classification dataset.
    ...
    def __init__(
        ...
        """Initialize the NoduleMNIST3D dataset.
