...
class SemanticSegmentationModule(module.ModelModule):
    ...
    @override
    def forward(self, image_tensor: torch.Tensor, *args: Any, **kwargs: Any) -> torch.Tensor:
        _, _, *image_size = image_tensor.shape
        patch_embeddings = self.encoder(image_tensor)
        return self.decoder(patch_embeddings, image_size)
