...
- Supports patch-level classification, slide-level classification, semantic segmentation, text classification, and multimodal (vision-language) downstream tasks
