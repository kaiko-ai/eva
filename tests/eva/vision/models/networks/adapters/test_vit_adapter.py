...
def test_vit_adapter_expected_learnable_parameters(vit_backbone: vision_transformer.VisionTransformer, input_tensor: torch.Tensor, freeze_vit: bool, learnable_parameters_expected: int) -> None:
    ...
    for hidden_state, shape_expected in zip(hidden_states, _HIDDEN_STATE_SHAPE_EXPECTED):
